...
public final class GlobalConstants {
	...
	public static final String JCAHTTP_COMMON_LOADER = "jcahttpserver_common";

	public static final String JCAHTTP_SERVER_LOADER = "jcahttpserver_server";
