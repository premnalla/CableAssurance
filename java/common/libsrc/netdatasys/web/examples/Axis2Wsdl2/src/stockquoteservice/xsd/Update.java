...
public class Update implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://StockQuoteService/xsd", "update", "ns1");
			...
			public void serialize(javax.xml.stream.XMLStreamWriter xmlWriter)
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter
								.writeStartElement(prefix, "symbol", namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://StockQuoteService/xsd", "symbol"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://StockQuoteService/xsd", "price"));
			...
			try {
						...
						if (!"update".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Update) stockquoteservice.xsd.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (!"true"
						...
						object
								.setSymbol(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					if (!"true"
						...
						object
								.setPrice(org.apache.axis2.databinding.utils.ConverterUtil
