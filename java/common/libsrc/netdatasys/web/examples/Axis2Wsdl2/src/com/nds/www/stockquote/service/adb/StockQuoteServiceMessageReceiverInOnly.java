...
public class StockQuoteServiceMessageReceiverInOnly extends
		...
		try {
			...
			if (op.getName() != null
				...
				if ("update".equals(methodName)) {
					...
					// doc style
					skel.update((stockquoteservice.xsd.Update) fromOM(inMessage
							.getEnvelope().getBody().getFirstElement(),
							stockquoteservice.xsd.Update.class,
	...
	private org.apache.axiom.om.OMElement toOM(
			stockquoteservice.xsd.Update param, boolean optimizeContent) {
	...
	private org.apache.axiom.om.OMElement toOM(
			stockquoteservice.xsd.GetPrice param, boolean optimizeContent) {
	...
	private org.apache.axiom.om.OMElement toOM(
			stockquoteservice.xsd.GetPriceResponse param,
			boolean optimizeContent) {

		return param.getOMElement(
				stockquoteservice.xsd.GetPriceResponse.MY_QNAME,
				org.apache.axiom.om.OMAbstractFactory.getOMFactory());
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (stockquoteservice.xsd.Update.class.equals(type)) {
				...
				return stockquoteservice.xsd.Update.Factory.parse(param
			...
			if (stockquoteservice.xsd.GetPrice.class.equals(type)) {
				...
				return stockquoteservice.xsd.GetPrice.Factory.parse(param
						.getXMLStreamReaderWithoutCaching());
			...
			if (stockquoteservice.xsd.GetPriceResponse.class.equals(type)) {
				...
				return stockquoteservice.xsd.GetPriceResponse.Factory
