...
public class GetQuoteBindingSkeleton implements wsdl.samples.stock.GetQuote, org.apache.axis.wsdl.Skeleton {
    private wsdl.samples.stock.GetQuote impl;
    ...
    */
    ...
    public GetQuoteBindingSkeleton() {
        this.impl = new wsdl.samples.stock.GetQuoteBindingImpl();
    }

    public GetQuoteBindingSkeleton(wsdl.samples.stock.GetQuote impl) {
        this.impl = impl;
    }
