...
public class Address  implements java.io.Serializable {
    ...
    private samples.addr.StateType state;

    private int zip;

    private samples.addr.Phone phoneNumber;
    ...
    public Address(
           ...
           samples.addr.StateType state,
           int zip,
           samples.addr.Phone phoneNumber) {
     ...
     * @return state
     */
    public samples.addr.StateType getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(samples.addr.StateType state) {
        this.state = state;
    }
     ...
     * @return phoneNumber
     */
    public samples.addr.Phone getPhoneNumber() {
        return phoneNumber;
    }
     ...
     * @param phoneNumber
     */
    public void setPhoneNumber(samples.addr.Phone phoneNumber) {
        this.phoneNumber = phoneNumber;
    }
