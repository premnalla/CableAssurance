...
public class LocalSystemServiceTestCase extends junit.framework.TestCase {
	...
	public void test1LocalSystemPortQueryLocalSystem() throws Exception {
		...
		try {
			binding = (com.nds.www.wsdl.CableAssurance.LocalSystemSOAPBindingStub) new com.nds.www.wsdl.CableAssurance.LocalSystemServiceLocator()
					.getLocalSystemPort();
