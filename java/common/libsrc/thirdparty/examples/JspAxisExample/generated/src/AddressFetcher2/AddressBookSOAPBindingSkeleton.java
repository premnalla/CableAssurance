...
public class AddressBookSOAPBindingSkeleton implements AddressFetcher2.AddressBook, org.apache.axis.wsdl.Skeleton {
    private AddressFetcher2.AddressBook impl;
    ...
    */
    ...
    static {
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            ...
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "address"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:AddressFetcher2", "address"), AddressFetcher2.Address.class, false, false), 
        };
    ...
    public AddressBookSOAPBindingSkeleton() {
        this.impl = new AddressFetcher2.AddressBookSOAPBindingImpl();
    }

    public AddressBookSOAPBindingSkeleton(AddressFetcher2.AddressBook impl) {
        this.impl = impl;
    }
    ...
    {
        AddressFetcher2.Address ret = impl.getAddressFromName(name);
        return ret;
    }
