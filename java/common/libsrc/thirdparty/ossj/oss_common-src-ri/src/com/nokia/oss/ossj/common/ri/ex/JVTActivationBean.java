...
public class JVTActivationBean implements javax.ejb.SessionBean 
{
    ...
    private static final String[] MANAGEDENTITY_TYPES = {
        ManagedEntityEx1Value.class.getName(),
        ManagedEntityEx2Value.class.getName(),
    ...
    private static final String[] MY_QUERY_TYPES = {
               QueryAllManagedEntitiesValue.class.getName()
    };
    ...
    String[] propnames = {
        ...
        ManagedEntityCreateEvent.class.getName(),
        propnames, proptypes,
        new ManagedEntityCreateEvent("dummy applicationDN", new ManagedEntityEx1Value())
        )
        );
    ...
    */
    ...
    throws javax.oss.IllegalArgumentException, java.rmi.RemoteException
    {
        ...
        if (!Arrays.asList(MANAGEDENTITY_TYPES).contains(valuetype)) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("ManagedEntity type "+valuetype+" ist not supported");
            throw e;
        }
        if (valuetype.equals(ManagedEntityEx1Value.class.getName())) 
        {
        
        	ManagedEntityEx1Value managedEntityValue = new ManagedEntityEx1Value();
        	managedEntityValue.setManagedEntityKeyDummy(new ManagedEntityEx1KeyImpl(getApplicationContext(), getApplicationDN(), valuetype));
        	//managedEntityValue.setLastModifiedOnServer(new java.util.Date());
        	return (ManagedEntityValue)managedEntityValue ;
	}
	else if (valuetype.equals(ManagedEntityEx2Value.class.getName())) 
        {
        
        	ManagedEntityEx2Value managedEntityValue = new ManagedEntityEx2Value();
        	managedEntityValue.setManagedEntityKeyDummy(new ManagedEntityEx2KeyImpl(getApplicationContext(), getApplicationDN(), valuetype));
        	//managedEntityValue.setLastModifiedOnServer(new java.util.Date());
		return (ManagedEntityValue)managedEntityValue ;
	}
        return null;
   ...
   * can be given and afterwards queryManagedEntitys can be called.
   *
   * <p><b>Postcondition:</b>
   * <ul>
   ...
   **/
    ...
    throws javax.oss.IllegalArgumentException, RemoteException	  {
        ...
        if (!java.util.Arrays.asList(MY_QUERY_TYPES).contains(queryName)) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("query \""+queryName+"\" not available");
                        throw e;
        }
    ...
    */
    ...
    public ManagedEntityValueIterator queryManagedEntities( QueryValue query , String[] attrNames)
    throws javax.oss.IllegalArgumentException ,java.rmi.RemoteException {
    	
        
        // implemtations yet to be done 
        
        ManagedEntityValueIterator anManagedValueIterator = null;
    ...
    throws javax.oss.IllegalArgumentException , java.rmi.RemoteException{
        ...
        for (int i=0 ; i<MY_EVENT_TYPES.length ; i++) {
            if (MY_EVENT_TYPES[i].equals(eventType)) {
                ...
                javax.oss.EventPropertyDescriptor returnEventDescriptor = (javax.oss.EventPropertyDescriptor)MANAGED_EVENT_DESCRIPTOR_MAP.get(eventType);
                return returnEventDescriptor;
            }
        }
        javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("eventType must be  value as returned by getEventTypes()");
        throw e;
    }
   ...
   */
    ...
    { 
       ...
       ManagedEntityExKey returnManagedEntityKey = null;
        ...
        if(managedEntityValue instanceof ManagedEntityEx1Value)
        {
                
        ManagedEntityEx1Value anManagedEntityValue = (ManagedEntityEx1Value)managedEntityValue;
        try {
            
             ManagedEntityEx1KeyImpl mgkey = new ManagedEntityEx1KeyImpl(getApplicationContext(), getApplicationDN(),ManagedEntityEx1Value.class.getName()  );
            
             mgkey.setPrimaryKey("ManagedEntityEx1Key"+count);
             count++;
            anManagedEntityValue.setManagedEntityKey(mgkey);
            
                   
         ManagedEntityEx1 aManagedEntity = manager.createManagedEntityEx1(anManagedEntityValue);
              returnManagedEntityKey = (ManagedEntityExKey)anManagedEntityValue.getManagedEntityKey();
getJmsSender().publish(new ManagedEntityCreateEvent(getApplicationDN(), anManagedEntityValue), ManagedEntityCreateEvent.class.getName(), aManagedEntity);
        } catch (Exception e) {
           
            CreateException e1 = new CreateException("could not create primary key by banu1. \n"+e.toString());
             throw e1;
        }
        }
        else if (managedEntityValue instanceof ManagedEntityEx2Value)
        {
             
        ManagedEntityEx2Value anManagedEntityValue = (ManagedEntityEx2Value)managedEntityValue;
        try {
            ManagedEntityEx2KeyImpl mg2key = new ManagedEntityEx2KeyImpl(getApplicationContext(), getApplicationDN(),ManagedEntityEx2Value.class.getName()  );
            
             mg2key.setPrimaryKey("ManagedEntityEx2Key"+count);
             count++;
            
            anManagedEntityValue.setManagedEntityKey(mg2key);
  ...
  getJmsSender().publish(new ManagedEntityCreateEvent(getApplicationDN(), anManagedEntityValue), ManagedEntityCreateEvent.class.getName(), aManagedEntity);
    ...
    */
    ...
    java.rmi.RemoteException
    {
            ...
            {
                javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException ("OrderKey[] argument may not be null");
                throw e;
            }
    ...
    * @exception javax.oss.IllegalArgumentException (Programmin Errorg) 
    * @exception javax.ejb.ObjectNotFoundException if precondition violated:
    *	 The <code>managedEntity.getManagedEntityKey()</code> must refer to an existing object.
    ...
    javax.ejb.ObjectNotFoundException,
      ...
      RemoteException    {
        ...
        if (!managedEntityValue.isPopulated(ManagedEntityValue.KEY)) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("No ManagedEnityKey in ManagedEntityValue");
            throw e;
        }
        if( manager == null)
         {
            javax.ejb.ObjectNotFoundException e = new javax.ejb.ObjectNotFoundException("Manager could not be found");
            throw e;
         }  
            
        if(managedEntityValue instanceof ManagedEntityEx1Value)
        {        
            manager.setManagedEntityEx1((ManagedEntityEx1Value)managedEntityValue);
        }
        else if (managedEntityValue instanceof ManagedEntityEx2Value)
            manager.setManagedEntityEx2((ManagedEntityEx2Value)managedEntityValue);
        
    }
    
    
   /**
    * Changes the attributes of multiple ManagedEntitys.
    ...
    */
    ...
    RemoteException {
        ...
        if (values == null) 
        {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException ("OrderValue[] argument may not be null");   
            throw e;
        }
        ...
        for (int i=0; i<values.length; i++) 
        {
            ...
            {
                result.add(new ManagedEntityExKeyResultImpl((ManagedEntityExKey)values[i].getManagedEntityKey(), false, e));
            } 
            catch (javax.oss.IllegalArgumentException e) 
            {
    ...
    * @exception javax.ejb.ObjectNotFoundException if precondition violated:
    *  
    * @exception javax.oss.IllegalArgumentException (Programming Error) 
    */
   ...
   /**
    * Returns values for a list of ManagedEntitys identified by the (unique) keys.
    * 
    * 
    * @exception javax.oss.IllegalArgumentException (Programming Error) 
    */
    public ManagedEntityValue[] getManagedEntitysByKeys(ManagedEntityExKey[] managedEntityKeys) 
    throws javax.oss.IllegalArgumentException
    , RemoteException
    {
        if (managedEntityKeys == null) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("Key array is of zero length");
             throw e;
        }
  ...
  private JmsSender getJmsSender() {
    ...
    private void checkManagedEntityKey(ManagedEntityKey anManagedEntityKey) throws javax.oss.IllegalArgumentException {
        
        if (anManagedEntityKey == null) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("ManagedEntityKey is null");
                        throw e;
        }
        if (!(anManagedEntityKey instanceof ManagedEntityExKey)) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("ManagedEntityKey not of the correct type");
            throw e;
        }
        if (!getApplicationDN().equals(anManagedEntityKey.getApplicationDN())) {
            javax.oss.IllegalArgumentException e = new javax.oss.IllegalArgumentException("ManagedEntityKey has different ApplicationDN than this application");
            throw e;
        }
