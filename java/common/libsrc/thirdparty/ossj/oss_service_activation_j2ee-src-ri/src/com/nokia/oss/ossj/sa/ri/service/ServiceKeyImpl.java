 ...
 * @version 1.0.1
 */
public class ServiceKeyImpl extends ManagedEntityKeyImpl implements ServiceKey,  java.io.Serializable {

    public ServiceKeyImpl() {
	}

    public ServiceKeyImpl( ApplicationContext anApplicationContext, String appTypeDN, String mevType, Object primaryKey )
    {
     ...
     */
    public Object clone() {
	ServiceKeyImpl myClone = (ServiceKeyImpl)super.clone();
