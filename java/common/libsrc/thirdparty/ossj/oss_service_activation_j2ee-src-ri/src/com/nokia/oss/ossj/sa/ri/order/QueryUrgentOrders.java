 ...
 * @version 1.0.1
 */
public interface QueryUrgentOrders extends javax.oss.QueryValue {
    
    public static final String REQUESTED_COMPLETION_DATE_THRESHOLD = "requestedCompletionDateThreshold";
