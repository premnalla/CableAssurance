 ...
 * @version 1.0.1
 */
public class OrderCreateEventImpl extends BaseEvent implements javax.oss.order.OrderCreateEvent {

    private javax.oss.order.OrderValue value;
    /** Creates new OrderCreateEventImpl */
    public OrderCreateEventImpl(String domain, javax.oss.order.OrderValue value) {
        super(domain);
        this.value = value;
    }
