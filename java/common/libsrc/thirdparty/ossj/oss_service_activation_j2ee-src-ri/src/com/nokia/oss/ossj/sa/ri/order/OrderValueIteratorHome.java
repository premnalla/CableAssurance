 ...
 * @version 1.0.1
 */
public interface OrderValueIteratorHome extends javax.ejb.EJBHome
{
    /** @link dependency */
    public RemoteOrderValueIterator create(OrderKey[] orderKeys, String[] attributes) throws RemoteException, CreateException;
}
