 ...
 * @version 1.0.1
 */
public class ServiceKeyResultImpl extends ManagedEntityKeyResultImpl implements javax.oss.service.ServiceKeyResult {
    
    public ServiceKeyResultImpl() {
    }
    
    /** Creates new ServiceKeyResultImpl */
    public ServiceKeyResultImpl(ServiceKey serviceKey, boolean success, Exception exception) {
        setManagedEntityKey(serviceKey);
        setSuccess(success);
        setException(exception);
    }

    public ServiceKey getServiceKey() {
        return (ServiceKey)getManagedEntityKey();
    }
    
    public void setServiceKey(ServiceKey newKey) {
