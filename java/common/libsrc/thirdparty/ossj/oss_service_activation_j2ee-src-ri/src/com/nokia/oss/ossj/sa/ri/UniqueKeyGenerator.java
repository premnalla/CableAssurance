 ...
 * @version 1.0.1
 */
public interface UniqueKeyGenerator extends EJBObject {
    
    public String getUniqueKey() throws RemoteException;
    public String[] getUniqueKeys(int amount) throws RemoteException;
