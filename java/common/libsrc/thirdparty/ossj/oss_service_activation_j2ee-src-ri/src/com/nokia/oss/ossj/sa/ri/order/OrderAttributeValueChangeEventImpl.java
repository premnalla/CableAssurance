 ...
 * @version 1.0.1
 */
public class OrderAttributeValueChangeEventImpl extends BaseEvent implements javax.oss.order.OrderAttributeValueChangeEvent {

    private javax.oss.order.OrderValue value;
    /** Creates new OrderAttributeValueChangeEventImpl */
    public OrderAttributeValueChangeEventImpl(String domain, javax.oss.order.OrderValue value) {
        super(domain);
        this.value = value;
    }
    public javax.oss.order.OrderValue getNewOrderValue() {
        return value;
    }
}
