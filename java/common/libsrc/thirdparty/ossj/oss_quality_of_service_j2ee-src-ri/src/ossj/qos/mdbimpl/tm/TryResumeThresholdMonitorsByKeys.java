...
public class TryResumeThresholdMonitorsByKeys {

String beginResponse = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <threshold:tryResumeThresholdMonitorsByKeysResponse xmlns=\"http://www.w3.org/2001/XMLSchema\"    xmlns:threshold=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold\"    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"    xmlns:co=\"http://java.sun.com/products/oss/xml/Common\"    xmlns:irp=\"http://java.sun.com/products/oss/xml/Common/Util\"    xmlns:measurement=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement\"    xmlns:pmUtil=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Util\"    xsi:schemaLocation=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold XmlQosPmThresholdSchema.xsd\"> <threshold:resumeThresholdMonitorsByKeys>";
String result = null;
String excption = null;
String endResponse = "</threshold:resumeThresholdMonitorsByKeys> </threshold:tryResumeThresholdMonitorsByKeysResponse>";
String beginExpection = "<threshold:tryResumeThresholdMonitorsByKeysException xmlns=\"http://www.w3.org/2001/XMLSchema\"    xmlns:threshold=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold\"    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"    xmlns:co=\"http://java.sun.com/products/oss/xml/Common\"    xmlns:irp=\"http://java.sun.com/products/oss/xml/Common/Util\"    xmlns:measurement=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement\"    xmlns:pmUtil=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Util\"    xsi:schemaLocation=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold XmlQosPmThresholdSchema.xsd> <co:remoteException>";
String endException = "</co:remoteException> </threshold:tryResumeThresholdMonitorsByKeysException>";
JVTThresholdMonitorSession tmSession = null;
ApplicationConnector ac = new ApplicationConnector();


  public TryResumeThresholdMonitorsByKeys() {
  }
  ...
  try{
   ...
   if(elm.getName().equalsIgnoreCase("tryResumeThresholdMonitorsByKeysRequest")){
   ...
   ThresholdMonitorKeyResult[] tmKeyResultArray = tmSession.tryResumeThresholdMonitorsByKeys(tmKeyArray);
