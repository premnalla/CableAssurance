...
ApplicationConnector ac = new ApplicationConnector();
  ...
  try{
   ...
   if(elm.getName().equalsIgnoreCase("tryRemovePerformanceMonitorsByKeysRequest")){
   ...
   PerformanceMonitorKeyResult[] pmKeyResultArray = pmSession.tryRemovePerformanceMonitorsByKeys(pmKeyArray);
