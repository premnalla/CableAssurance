...
public class IrenePmClient {
	...
	public HashMap observableObjects;
     ...
     public static IrenePmClient pmClient = null;
     ...
     * Create new client.
     */
    public IrenePmClient() {
    }

    public IrenePmClient(String FileName) {
        ...
        File propertyFile = new File(FileName);
            ...
            String homeName = "System/Gothenburg/ApplicationType/PerformanceMonitor/Application/1-0;1-0;JSR90RIPM/Comp/JVTHome";
    ...
    public static IrenePmClient getInstance(String fileName) {
        if(pmClient == null) {
            pmClient = new IrenePmClient(fileName);
        }
	...
	System.out.println(homeName);
        ...
        // create pm client
        IrenePmClient pmClient = new IrenePmClient();
        ...
        try {
            ...
            pmClient.connectToPmSession(homeName);
	...
	public void run ()
		...
		System.out.println("6) Display All observable Classes , Object and Attributes ");
        ...
        String filter, MessageListener listener ) throws PmClientException
 {
    ...
    public PerformanceMonitorKey createPmMonitorJobByObject(String jobname, String objname) {
       ...
       //System.out.println("wrx --before make PerfValue");
        PerformanceMonitorByObjectsValue pmByObjectsValue = 
         ...
         //System.out.println("wrx --after make PerfValue");
        ...
        //pmByObjectsValue.setGranularityPeriod(3*60); 
...
*/
            ...
            int granu[] = pmSession.getSupportedGranularities(pmByObjectsValue); 
            pmByObjectsValue.setGranularityPeriod(granu[0]);
           ...
           //System.out.println("wrx--when create per"); 
            e.printStackTrace();
            return null;
        }
    }
    ...
    private PerformanceMonitorKey createPmMonitorJobByClass(String jobname, String classname) 
        ...
        // 15 minute granularity period, could also use 
        // getSupportedGranularities() to get the supported GP.  
        pmByClassesValue.setGranularityPeriod(3*60); 
        // Assume we want the report for a 3G network and we want it in XML. 
        // Find the appropriate ReportFormat. 
        ReportFormat formatXML3G = null; 
        ReportFormat[] formats = pmSession.getReportFormats(); 
			...
			+ "===========");
               ...
               for (PerformanceMonitorValue pmVals[] = 
                   ...
                   for (int i=0; i < pmVals.length; i++) {
                        ...
                        System.out.println( String.valueOf(i)+  ")  " + pmVals[i].getName());
                   }
               }
