...
/**
 * AlarmValueXmlSerializerImpl
 *
 * @author Copyright 2001-2002 Nortel Networks Limited. All rights reserved
 */

public class AlarmValueXmlSerializerImpl implements javax.oss.XmlSerializer
{
    ...
    AlarmValueXmlSerializerImpl( String type ) {
        this.type = type;
    }
   ...
   public  String[] getSupportedEncodingStyles() {
    ...
    throws java.lang.IllegalArgumentException {
     ...
     //VP: System.out.println( "---->>>XmlSerializerImpl.toXml<<<----" );
     String doc = null;
     try {
     doc = AlarmXmlTranslator.toXml( ( AlarmValue ) object, elementName );
     }
     catch( Exception e ) {
    ...
    throws java.lang.IllegalArgumentException {
        //VP: System.out.println( "---->>>AlarmBalueXmlSerializerImpl.fromXml<<<----" );
        Object o = null;
        //VP: System.out.println( "Calling AlarmXmlTranslator.fromXml" );
        o = AlarmXmlTranslator.fromXml( element, type );
        //VP: System.out.println( "Returning from  AlarmXmlTranslator.fromXml" );
