...
ApplicationConnector ac = new ApplicationConnector();
  ...
  try{
   ...
   if(elm.getName().equalsIgnoreCase("trySuspendPerformanceMonitorsByKeysRequest")){
   ...
   PerformanceMonitorKeyResult[] pmKeyResultArray = pmSession.trySuspendPerformanceMonitorsByKeys(pmKeyArray);
