...
ApplicationConnector ac = new ApplicationConnector();
  ...
  try{
   ...
   if(elm.getName().equalsIgnoreCase("trySuspendThresholdMonitorsByKeysRequest")){
   ...
   ThresholdMonitorKeyResult[] tmKeyResultArray = tmSession.trySuspendThresholdMonitorsByKeys(tmKeyArray);
