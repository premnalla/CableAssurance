...
public class TryResumePerformanceMonitorsByKeys {

//hooman
String beginResponse = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>  <measurement:tryResumePerformanceMonitorsByKeysResponse xmlns=\"http://www.w3.org/2001/XMLSchema\"     xmlns:measurement=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement\"    xmlns:threshold=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold\"    xmlns:fm=\"http://java.sun.com/products/oss/xml/QualityOfService/FM/Monitor\"    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"    xmlns:co=\"http://java.sun.com/products/oss/xml/Common\"    xmlns:irp=\"http://java.sun.com/products/oss/xml/Common/Util\"    xmlns:pmUtil=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Util\"    xsi:schemaLocation=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement XmlQosPmMeasurementSchema.xsd\"> <measurement:resumePerformanceMonitorsByKeys>";
String result = null;
String excption = null;
String endResponse = "</measurement : resumePerformanceMonitorsByKeys> </measurement:tryResumePerformanceMonitorsByKeysResponse>";
String beginExpection = "<measurement:tryResumePerformanceMonitorsByKeysException xmlns=\"http://www.w3.org/2001/XMLSchema\"     xmlns:measurement=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement\"    xmlns:threshold=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Threshold\"    xmlns:fm=\"http://java.sun.com/products/oss/xml/QualityOfService/FM/Monitor\"    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"    xmlns:co=\"http://java.sun.com/products/oss/xml/Common\"    xmlns:irp=\"http://java.sun.com/products/oss/xml/Common/Util\"    xmlns:pmUtil=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Util\"    xsi:schemaLocation=\"http://java.sun.com/products/oss/xml/QualityOfService/PM/Measurement XmlQosPmMeasurementSchema.xsd\"> <co:remoteException>";
String endException = "</co:remoteException> </measurement:tryResumePerformanceMonitorsByKeysException>";
JVTPerformanceMonitorSession pmSession = null;
ApplicationConnector ac = new ApplicationConnector();

  public TryResumePerformanceMonitorsByKeys() {
  }

  public String getResponse(org.jdom.Element elm){
   String xmlResponse = null;
   PerformanceMonitorKey[] pmKeyArray = null;
   DOMOutputter dout = new DOMOutputter();
  try{
     pmSession = ac.getPMRemote();
   if(elm.getName().equalsIgnoreCase("measurement:tryResumePerformanceMonitorsByKeysRequest")){
    org.jdom.Element elm1 = elm.getChild("pmKeys");
    ...
    while(it.hasNext())
	{
          ...
          pmKeyArray[i] = (PerformanceMonitorKey)PerformanceMonitorKeyXmlTranslator.fromXml(elmDom, PerformanceMonitorKey.class.getName());

            }
          }

   PerformanceMonitorKeyResult[] pmKeyResultArray = pmSession.tryResumePerformanceMonitorsByKeys(pmKeyArray);
