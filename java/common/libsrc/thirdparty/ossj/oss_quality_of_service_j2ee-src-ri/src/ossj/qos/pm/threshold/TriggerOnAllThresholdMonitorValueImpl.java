...
/**
 * Implements the TriggerOnAllThresholdMonitorValue
 * interface.
...
public class TriggerOnAllThresholdMonitorValueImpl extends ThresholdMonitorValueImpl implements TriggerOnAllThresholdMonitorValue  {
    ...
    public TriggerOnAllThresholdMonitorValueImpl() {
       Log.write(this,Log.LOG_ALL,"TriggerOnAllThresholdMonitorValueImpl()","called");

        // populate all attributes
        map.put( TriggerOnAllThresholdMonitorValue.ALARM_CONFIG,null );
        map.put( TriggerOnAllThresholdMonitorValue.DEFINITIONS,null );
        map.put( TriggerOnAllThresholdMonitorValue.OBSERVABLE_OBJECTS,null );
    }
    ...
    public void setObservableObjects(String[] observableobjects)  throws java.lang.IllegalArgumentException {
        ...
        setAttributeValue( TriggerOnAllThresholdMonitorValue.OBSERVABLE_OBJECTS, observableobjects );
    }
