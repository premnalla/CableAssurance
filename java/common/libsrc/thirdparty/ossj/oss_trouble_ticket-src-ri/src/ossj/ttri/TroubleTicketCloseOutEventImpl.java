...
/**
 * TroubleTicketCloseOutEvent Implementation Class
 *
 *
 ...
 * @since February 2002
 */
public class TroubleTicketCloseOutEventImpl extends TroubleTicketEvent
        implements TroubleTicketCloseOutEvent,
        Serializable,
        Cloneable {
    ...
    public javax.oss.Serializer makeSerializer(String serializerType)
        ...
        if (serializerType.equals(XmlSerializer.class.getName()))
            return new XmlSerializerImpl(TroubleTicketCloseOutEvent.class.getName());
        else
    ...
    private static final String RootElementTag = "troubleTicketCloseOutEvent";

    public TroubleTicketCloseOutEventImpl() {
        setEventType("TroubleTicketCloseOutEvent");
    ...
    public void setTroubleTicketValue(TroubleTicketValue val) {
        Logger.log("TroubleTicketCloseOutEventImpl::setTroubleTicketValue");
        this.ttValue = val;
    }
    ...
    public boolean equals(Object arg) {
        ...
        if ((arg != null) && (arg instanceof TroubleTicketCloseOutEvent)) {

            TroubleTicketCloseOutEvent event = (TroubleTicketCloseOutEvent) arg;
