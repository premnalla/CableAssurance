...
/**
 * TroubleTicketAttributeValueChangeEvent Implementation Class
 *
 * @author Copyright 2002 MetaSolv Software, Inc. All rights reserved.
 * @version 1.0
 * @since February 2002
 */
public class TroubleTicketAttributeValueChangeEventImpl
        extends TroubleTicketEvent
        implements TroubleTicketAttributeValueChangeEvent,
    ...
    public javax.oss.Serializer makeSerializer(String serializerType)
        ...
        if (serializerType.equals(XmlSerializer.class.getName()))
            return new XmlSerializerImpl(TroubleTicketAttributeValueChangeEvent.class.getName());
        else
    ...
    public TroubleTicketValue getNewTroubleTicketValue() {
        return ttValue;
    }

    public void setNewTroubleTicketValue(TroubleTicketValue value) {
        ttValue = value;
    }

    private static final String RootElementTag = "troubleTicketAttributeValueChangeEvent";


    public TroubleTicketAttributeValueChangeEventImpl() {
        //setEventType("TroubleTicketCreationEvent");
        setEventType("TroubleTicketAttributeValueChangeEvent");    //WIPRO
    ...
    public boolean equals(Object arg) {
        ...
        if ((arg != null) && (arg instanceof TroubleTicketAttributeValueChangeEvent)) {

            TroubleTicketAttributeValueChangeEvent event = (TroubleTicketAttributeValueChangeEvent) arg;
