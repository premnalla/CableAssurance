...
public class JVTTroubleTicketSessionBean implements SessionBean {
    ...
    private static final String[] SupportedOperations = {createTroubleTicketOp,
                                                         ...
                                                         getTroubleTicketOp,
                                                         getTroubleTicketsOp};
    private static final String[] MANAGEDENTITY_TYPES = {TroubleTicketValueImpl.class.getName()};
    //private static final String[] QUERY_TYPES ={QueryAllOpenTroubleTicketsImpl.class.getName()};  //WIPRO
