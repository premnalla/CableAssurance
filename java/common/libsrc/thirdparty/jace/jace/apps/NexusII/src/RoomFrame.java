/*
   ...
   Last Update: $Date: 2006/04/13 18:46:43 $
   $Revision: 1.1.1.1 $

   REVISION HISTORY:
   $Log: RoomFrame.java,v $
   Revision 1.1.1.1  2006/04/13 18:46:43  prem
   Initial
...
class RoomFrame extends CFrame implements consts {
  private static String rcsId = new String("$Id: RoomFrame.java,v 1.1.1.1 2006/04/13 18:46:43 prem Exp $");
