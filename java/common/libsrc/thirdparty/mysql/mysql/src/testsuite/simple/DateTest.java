 ...
 * @version $Id: DateTest.java,v 1.1.1.1 2006/04/05 02:30:24 prem Exp $
 */
public class DateTest extends BaseTestCase {
	...
	public void testZeroDateBehavior() throws Exception {
		try {
			...
			assertTrue("0001-01-01 00:00:00.0".equals(this.rs.getTimestamp(1)
					.toString()));
			assertTrue("0001-01-01".equals(this.rs.getDate(2).toString()));
			assertTrue("0001-01-01 00:00:00.0".equals(this.rs.getTimestamp(2)
					.toString()));
