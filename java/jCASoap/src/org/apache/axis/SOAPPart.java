...
public class SOAPPart extends javax.xml.soap.SOAPPart implements Part
{
	...
	public Object setUserData(String s, Object o, UserDataHandler u) {
		return null;
	}
	public DOMConfiguration getDomConfig() {
		return (null);
	}
	public String lookupPrefix(String in) {
		return (in);
	}
	public Object getUserData(String in) {
		return (in);
	}
	...
	public void setXmlVersion(String in) {
		
	}
	public Node renameNode(Node nd, String s1, String s2) {
		return null;
	}
	public Object getFeature(String s1, String s2) {
		return null;
	}
	public boolean isEqualNode(Node nd) {
		return false;
	}
	...
	public void setTextContent(String in) {
