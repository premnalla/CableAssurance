 ...
 * 
 */
public class MtaCurrentAvailability extends AbstractCurrentStatus {

	private static Log log = LogFactory.getLog(MtaCurrentAvailability.class);

	/**
	 * 
	 * 
	 */
	public MtaCurrentAvailability() {
		super();
	}
	 ...
	 * @param resId
	 */
	public MtaCurrentAvailability(Long resId) {
		super(resId);
		querySelf();
	}
	 ...
	 * @param rs
	 */
	public MtaCurrentAvailability(ProxyDbResultSet rs) {
		int i = 1;
		try {
			i++; // skip 'id' field
	...
	private void querySelf() {
		...
		try {
			...
			StringBuffer qryStr = new StringBuffer(
					GlobalQueries.QRY_CURRENT_MTA_AVAILABILITY);
