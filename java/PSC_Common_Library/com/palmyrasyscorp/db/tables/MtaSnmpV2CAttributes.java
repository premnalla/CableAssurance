 ...
 * 
 */
public class MtaSnmpV2CAttributes extends SnmpV2CAttributes {

	private static Log log = LogFactory.getLog(MtaSnmpV2CAttributes.class);

	/**
	 * 
	 * 
	 */
	public MtaSnmpV2CAttributes() {
		super();
	}
	 ...
	 * 
	 */
	public MtaSnmpV2CAttributes(long cmtsResId) {
		super(cmtsResId);
		querySelf();
	}
	 ...
	 * @param ih
	 */
	public MtaSnmpV2CAttributes(ProxyDbResultSet rs, IntegerHolder ih) {
		super(rs, ih);
	}
	 ...
	 * @param rs
	 */
	public MtaSnmpV2CAttributes(ProxyDbResultSet rs) {
		super(rs);
	}
	...
	public boolean updateRow() {
		...
		try {
			...
			StringBuffer updStr = new StringBuffer(
					"update canet.cmts_mta_v2c_attributes set ");
	...
	public boolean insertRow() {
		...
		try {
			 ...
			 */
			StringBuffer updStr = new StringBuffer(
					"insert into canet.cmts_mta_v2c_attributes(cmts_res_id,read_community,write_community) values(");
	...
	private void querySelf() {
		...
		try {
			...
			StringBuffer qryStr = new StringBuffer(
					GlobalQueries.QRY_MTA_SNMP_V2C_ATTR);
