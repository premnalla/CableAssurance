 ...
 * 
 */
public class TopoCmLookup extends AbstractTopoLookup {

	private static Log log = LogFactory.getLog(TopoCmLookup.class);
	...
	public TopoCmLookup(String mac) {
		super();
		querySelf();
	}
	 ...
	 * @param rs
	 */
	public TopoCmLookup(ProxyDbResultSet rs) {
		super(rs);
	}
	...
	private void querySelf() {
		...
		try {
			 ...
			 * Create sql
			 */
			String qryStr = "SELECT * FROM canet.topo_lookup_cm lc WHERE lc.mac_address="
				+ getMac();
