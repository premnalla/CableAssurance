...
public final class CGIServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (debug >= 10) {
            try {
                ...
                out.println("<BODY>$Header: /opt/projects/CvsRoot/jCAHttpServer/src/org/apache/catalina/servlets/CGIServlet.java,v 1.1 2007/03/01 20:19:04 prem Exp $<p>");
    ...
    public static void main(String[] args) {
        System.out.println("$Header: /opt/projects/CvsRoot/jCAHttpServer/src/org/apache/catalina/servlets/CGIServlet.java,v 1.1 2007/03/01 20:19:04 prem Exp $");
    }
