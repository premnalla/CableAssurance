 ...
 * @version $Revision: 1.4 $ $Date: 2007/03/01 17:38:48 $
 */
...
public class Catalina extends Embedded {
	...
	protected File getConfigFile() {
		...
		File file = new File(System.getProperty(GlobalConstants.JCAHTTP_SERVER_HOME)
    ...
    public void load() {
        ...
        System.out.println("Loaded " + getConfigFileName());
            ...
            try {
                ...
                inputSource = new InputSource
                    (getClass().getClassLoader()
                     .getResource(getConfigFileName()).toString());
            } catch (Exception e) {
            	e.printStackTrace();
            	System.out.println("Exitting...");
            	System.exit(-1);
