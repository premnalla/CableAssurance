...
<%
	...
	StringBuffer actionUrl = new StringBuffer(CAJspPages.JSP_REPORT_MTA_STATUS_FILT);
...
<tr class="alarms_tr_th">
	...
	<th><%=rb.getString(ResourceKeys.K_SUM_UNAVAIL_DURATION) %></th>
	<th><%=rb.getString(ResourceKeys.K_SUM_AVAIL_DURATION) %></th>
...
<%
	...
	if (qryType.compareTo(UrlHelper.REPORT_TYPE_ST_DURATION)==0) {
		...
		result = 
			rh.getMtaStatusSummary2(tK, null, null, fromTime, toTime, batch, qrySt);				
	} else {
		result = null;
	}
