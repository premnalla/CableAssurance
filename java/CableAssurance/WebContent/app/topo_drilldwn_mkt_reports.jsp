...
<%
	...
	StringBuffer cmtsUrl = new StringBuffer(CAJspPages.JSP_TOPO_ROOT_MARKET);
	StringBuffer cmsUrl = new StringBuffer(CAJspPages.JSP_TOPO_MKT_CMSes);
...
<table>
<tr>
<td class="ca_h1"><%=rb.getString(ResourceKeys.K_REPORTS_FOR_MKT) %> : </td>
