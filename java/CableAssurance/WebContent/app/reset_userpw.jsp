...
<%
	...
	StringBuffer missingDataUrl = new StringBuffer("../app/reset_userpw_form_mf.jsp?");
...
<%
	/*
	 * Reset User Password to the DB and return to previous page
	 */
	String loginId = request.getParameter(UrlHelper.LOGIN_ID);
	admHelper.updateUserPassword(loginId, BackBean.getLoginPw());
%>
