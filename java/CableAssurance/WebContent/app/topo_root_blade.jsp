...
<script src="../js/net_obj_menu_bld.js" type="text/javascript">
</script>
</head>
...
<%
	...
	StringBuffer cmtsUrl = new StringBuffer("../app/topo_root_blade.jsp");
	StringBuffer reportsUrl = new StringBuffer("../app/topo_drilldwn_bld_reports.jsp");
%>
...
<table>
<tr>
<td class="ca_h1_nm"><%=rb.getString(ResourceKeys.K_CMTS_ES) %> <%=rb.getString(ResourceKeys.K_FOR) %> <%=rb.getString(ResourceKeys.K_BLADE) %> : </td>
