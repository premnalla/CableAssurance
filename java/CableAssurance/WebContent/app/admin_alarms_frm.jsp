...
<%
	StringBuffer adminTab = new StringBuffer("../app/admin_alarms_tab_menu.jsp");
...
<frameset rows="60px,*">
	<frame src="<%=adminTab.toString() %>" frameborder="0" marginheight="0"
		marginwidth="0" noresize="noresize" name="<%=UrlHelper.ADMIN_ALARM_TAB_MENU_FRAME %>">
	</frame>
	<frame src="<%=tabData.toString() %>" frameborder="0" marginheight="0"
		marginwidth="0" noresize="noresize" name="<%=UrlHelper.ADMIN_ALARM_TAB_DATA_FRAME %>">
	</frame>
</frameset>
</html>