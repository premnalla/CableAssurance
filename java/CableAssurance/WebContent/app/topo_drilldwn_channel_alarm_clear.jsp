...
<%
	...
	StringBuffer viewAlarmsUrl = new StringBuffer("../app/topo_drilldwn_channel_alarms.jsp?");
	viewAlarmsUrl.append(request.getQueryString());

	StringBuffer selectAlarmsUrl = new StringBuffer("../app/topo_drilldwn_channel_alarm_selected.jsp?");
