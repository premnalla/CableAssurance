...
<%
	...
	if (devType != null && devType.equals(UrlHelper.MTA)) {
		StringBuffer url_1 = new StringBuffer("../app/csr_portal_result_cmts.jsp");
		...
		StringBuffer url_2 = new StringBuffer("../app/csr_portal_result_cm.jsp");
		url_2.append("?").append(request.getQueryString());
		h = new CsrUrlHolder();
		h.url = url_2.toString();
		h.frameName = UrlHelper.CSR_DATA_CM_FRAME;
		l.add(h);
		
		StringBuffer url_3 = new StringBuffer("../app/csr_portal_result_cadb.jsp");
		url_3.append("?").append(request.getQueryString());		
		h = new CsrUrlHolder();
		h.url = url_3.toString();
		h.frameName = UrlHelper.CSR_DATA_CADB_FRAME;
		l.add(h);
