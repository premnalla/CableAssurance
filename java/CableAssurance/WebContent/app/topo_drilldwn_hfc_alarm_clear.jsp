...
<%
	...
	StringBuffer viewAlarmsUrl = new StringBuffer("../app/topo_drilldwn_hfc_alarms.jsp?");
	viewAlarmsUrl.append(request.getQueryString());

	StringBuffer selectAlarmsUrl = new StringBuffer("../app/topo_drilldwn_hfc_alarm_selected.jsp?");
