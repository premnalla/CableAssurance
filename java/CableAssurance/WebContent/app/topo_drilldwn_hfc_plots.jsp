...
<%@ page import="com.palmyrasyscorp.www.chart.HfcCountsChartCollection"%>
...
<%
	...
	StringBuffer plotsUrl = new StringBuffer(
		"../app/topo_drilldwn_hfc_plots.jsp");
	...
	StringBuffer alarmsUrl = new StringBuffer(
		"../app/topo_drilldwn_hfc_alarms.jsp");
	...
	"../app/topo_drilldwn_hfc_reports.jsp");
	UrlHelper.AppendTopoHierarchyIDs(reportsUrl, tK);
	reportsUrl.append("&").append(UrlHelper.RESOURCE_ID).append("=")
	.append(resId);

	HfcCountsChartCollection ccc = new HfcCountsChartCollection(tK, hfcRId);
