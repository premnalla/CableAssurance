...
<%
	...
	StringBuffer viewAlarmsUrl = new StringBuffer("../app/topo_drilldwn_emta_alarms.jsp?");
	viewAlarmsUrl.append(request.getQueryString());

	StringBuffer selectAlarmsUrl = new StringBuffer("../app/topo_drilldwn_emta_alarm_selected.jsp?");
