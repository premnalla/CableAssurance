...
<table>
	<tr class="xsmall">
		<td><%=rb.getString(ResourceKeys.K_FROM) %></td>
	...
	<tr class="xsmall">
		<td><%=rb.getString(ResourceKeys.K_TO) %></td>
		...
		<td><input type="reset" value="Clear" name="clear"/><input type="submit" value="Filter" name="filter"/></td>
	</tr>
</table>
</form>
</div>
