 ...
 *
 */
public class HfcCountsDataCreator extends AbstractCountsDataCreator {

	/**
	 * 
	 */
	public HfcCountsDataCreator(TopoHierarchyKeyT tK, BigInteger resId) {
		super(tK, resId);
	}
	...
	protected GenericCountsHistoryT[] getCountsHistory() {
		...
		QueryStateT qs = null;
		GenericCountsHistoryT[] s = p.getHfcCountsHistory(getTopKey(),
