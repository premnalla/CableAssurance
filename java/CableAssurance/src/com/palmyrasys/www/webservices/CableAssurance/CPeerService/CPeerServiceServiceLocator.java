...
public class CPeerServiceServiceLocator extends org.apache.axis.client.Service
		implements
		com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceService {
	...
	public CPeerServiceServiceLocator(java.lang.String wsdlLoc,
	...
	private String EP_HostPort = "localhost:9091";

	public void setHost(String s) {
		this.EP_HostPort = s;
	}

	private String EP_Path = "/CableAssurance/caservices/CPeerServiceEP";

	// Use to get a proxy class for CPeerServiceEP
	// Prem:
	// private java.lang.String CPeerServiceEP_address =
	// "http://192.168.1.104:9091/CableAssurance/caservices/CPeerServiceEP";
	...
	public com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceEP getCPeerServiceEP()
			throws javax.xml.rpc.ServiceException {
		java.net.URL endpoint;
		try {
			endpoint = new java.net.URL(getCPeerServiceEPAddress());
	...
	public com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceEP getCPeerServiceEP(
		...
		try {
			com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceSOAPBindingStub _stub = new com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceSOAPBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceEP.class
					.isAssignableFrom(serviceEndpointInterface)) {
				com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceSOAPBindingStub _stub = new com.palmyrasys.www.webservices.CableAssurance.CPeerService.CPeerServiceSOAPBindingStub(
						new java.net.URL(getCPeerServiceEPAddress()), this);
				_stub.setPortName(getCPeerServiceEPWSDDServiceName());
				return _stub;
			}
