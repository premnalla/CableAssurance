...
import com.palmyrasys.www.webservices.CableAssurance.SnmpVersionT;
import com.palmyrasys.www.webservices.CableAssurance.Common.TopoKeyHelper;
import com.palmyrasyscorp.www.jsp.bean.NewCmtsFormBean;
...
// public class CmtsT  implements java.io.Serializable {
	...
	private static Log log = LogFactory.getLog(CmtsT.class);
    ...
    public CmtsT(Cmts c) {
    	try {
	    	...
	    	if (c.getCurrentCounts().getCmTotal() != null) {
	    		this.counts = new GenericCountsT(c.getCurrentCounts());
	    	}
	        this.cmtsHost = c.getHost();
	        this.cmtsSnmpVersion = SnmpVersionT.v2c;
	        this.cmSnmpVersion = SnmpVersionT.v2c;
	        this.mtaSnmpVersion = SnmpVersionT.v2c;
	        this.statusColor = 
     ...
     * @param bean
     */
    public CmtsT(NewCmtsFormBean bean) {
    	try {
	    	this.cmtsName = bean.getCmtsName();
	    	this.cmtsResId = new java.math.BigInteger("0");
	   		this.counts = new GenericCountsT();
	        this.cmtsHost = bean.getCmtsHost();
	        this.cmtsSnmpVersion = SnmpVersionT.v2c;
	        this.cmSnmpVersion = SnmpVersionT.v2c;
	        this.mtaSnmpVersion = SnmpVersionT.v2c;
