...
public class ResultBatchT  implements java.io.Serializable {
     ...
     * @author Prem
     */
    static private short MAX_BATCH_SIZE = 100;
    ...
    public ResultBatchT(
    	...
    	if (fromIndex > toIndex) {
            this.fromIndex = (short) toIndex;
            this.toIndex = (short) fromIndex;    		
    	} else {
            this.fromIndex = (short) fromIndex;
            this.toIndex = (short) toIndex;    		
    	}
     }
     ...
     * @param s
     */
    public void setMaxBatchSize(short s) {
    	MAX_BATCH_SIZE = s;
    }
    ...
    public short getBatchSize() {
    	...
    	if (toIndex > fromIndex) {
    		batchSize = (short)(toIndex - fromIndex + 1);
    	} else {
    		batchSize = (short) (fromIndex - toIndex + 1);
    	}
     ...
     * @return
     */
    public boolean greaterThan(ResultBatchT o) {
    	return (this.fromIndex > o.getFromIndex());
    }
