...
public class CmPerformanceT  implements java.io.Serializable {
	...
	private static Log log = LogFactory.getLog(CmPerformanceT.class);
     ...
     * @param dbPerf
     */
    public CmPerformanceT(CmPerformanceHistory dbPerf) {
		try {
	        this.downstreamSNR = dbPerf.getDownstreamSNR().shortValue();
	        this.downstreamPower = dbPerf.getDownstreamPower().shortValue();
	        this.upstreamPower = dbPerf.getUpstreamPower().shortValue();
	        this.t1Timeouts = dbPerf.getT1Timeouts().shortValue();
	        this.t2Timeouts = dbPerf.getT2Timeouts().shortValue();
	        this.t3Timeouts = dbPerf.getT3Timeouts().shortValue();
	        this.t4Timeouts = dbPerf.getT4Timeouts().shortValue();    	
		} catch (Exception e) {
			// e.printStackTrace();
			log.error(null, e);	
		}
     ...
     * @param dbPerf
     */
    public CmPerformanceT(CmCurrentPerformance dbPerf) {
    	try {
	        this.downstreamSNR = dbPerf.getDownstreamSNR().shortValue();
	        this.downstreamPower = dbPerf.getDownstreamPower().shortValue();
	        this.upstreamPower = dbPerf.getUpstreamPower().shortValue();
