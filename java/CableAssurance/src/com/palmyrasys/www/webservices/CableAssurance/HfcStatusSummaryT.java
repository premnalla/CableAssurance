...
public class HfcStatusSummaryT extends AbstractCAServiceObject  implements java.io.Serializable, UniqueObject {

	private static Log log = LogFactory.getLog(HfcStatusSummaryT.class);
     ...
     * @param dbSumm
     */
    public HfcStatusSummaryT(HfcStatusSummary dbSumm) {
    	try {
