...
import com.palmyrasyscorp.www.jsp.bean.AdminPerfCmBean;

public class CmPerformanceConfigT  implements java.io.Serializable {

	private static Log log = LogFactory.getLog(CmPerformanceConfigT.class);
     ...
     * @param bean
     */
    public CmPerformanceConfigT(AdminPerfCmBean bean) {
		try {
	        this.downstreamSnrLower = bean.getLowDwnStrmSnr();
	        this.downstreamPowerLower = bean.getLowDwnStrmPower();
	        this.downstreamPowerUpper = bean.getUpDwnStrmPower();
	        this.upstreamPowerLower = bean.getLowUpStrmPower();
	        this.upstreamPowerUpper = bean.getUpUpStrmPower();    	
		} catch (Exception e) {
			// e.printStackTrace();
			log.error(null, e);	
		}
     ...
     * @param ac
     */
    public CmPerformanceConfigT(AppConfig ac) {
		try {
	    	this.downstreamSnrLower = ac.getValue(AppConfig.cm_perf_downstream_snr_lower);
	        this.downstreamPowerLower = ac.getValue(AppConfig.cm_perf_downstream_power_lower);
	        this.downstreamPowerUpper = ac.getValue(AppConfig.cm_perf_downstream_power_upper);
	        this.upstreamPowerLower = ac.getValue(AppConfig.cm_perf_upstream_power_lower);
	        this.upstreamPowerUpper = ac.getValue(AppConfig.cm_perf_upstream_power_upper);    	
		} catch (Exception e) {
			// e.printStackTrace();
			log.error(null, e);	
		}
