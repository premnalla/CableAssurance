...
public class CsrPortalSOAPBindingStub extends org.apache.axis.client.Stub implements com.palmyrasys.www.webservices.CableAssurance.CsrPortal.CsrPortalEP {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getCmByMac");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "macAddress"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "cm"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getMtaByMac");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "macAddress"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "mta"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public CsrPortalSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CsrPortalSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CsrPortalSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public com.palmyrasys.www.webservices.CableAssurance.CTEDataT[] getCustomerByName(java.lang.String firstName, java.lang.String lastName) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.palmyrasys.com/webservices/CableAssurance/CsrPortal", "getCustomerByName"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {firstName, lastName});
  ...
  throw axisFaultException;
    ...
    public com.palmyrasys.www.webservices.CableAssurance.CableModemT getCmByMac(java.lang.String macAddress) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.palmyrasys.com/webservices/CableAssurance/CsrPortal", "getCmByMac"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {macAddress});
  ...
  throw axisFaultException;
    ...
    public com.palmyrasys.www.webservices.CableAssurance.EmtaT getMtaByMac(java.lang.String macAddress) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.palmyrasys.com/webservices/CableAssurance/CsrPortal", "getMtaByMac"));
