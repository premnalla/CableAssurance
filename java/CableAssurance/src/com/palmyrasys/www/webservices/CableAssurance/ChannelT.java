...
public class ChannelT  implements java.io.Serializable {
	...
	private static Log log = LogFactory.getLog(ChannelT.class);
    ...
    public ChannelT(Channel dbChnl) {
		try {
	    	...
	    	if (dbChnl.getCurrentCounts().getCmTotal() != null) {
	    		this.counts = new GenericCountsT(dbChnl.getCurrentCounts());
	    	}
	        this.statusColor = 
	        	StatusColorHelper.AlertLevelToStatusColor(dbChnl);
