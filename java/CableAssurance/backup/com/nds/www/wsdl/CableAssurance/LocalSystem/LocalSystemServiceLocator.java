...
public class LocalSystemServiceLocator extends org.apache.axis.client.Service implements com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemService {
    ...
    public com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemEP getLocalSystemEP() throws javax.xml.rpc.ServiceException {
    ...
    public com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemEP getLocalSystemEP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemSOAPBindingStub _stub = new com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemSOAPBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemEP.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemSOAPBindingStub _stub = new com.nds.www.wsdl.CableAssurance.LocalSystem.LocalSystemSOAPBindingStub(new java.net.URL(LocalSystemEP_address), this);
                _stub.setPortName(getLocalSystemEPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.nds.com/wsdl/CableAssurance/LocalSystem", "LocalSystemService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.nds.com/wsdl/CableAssurance/LocalSystem", "LocalSystemEP"));
        }
