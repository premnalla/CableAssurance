    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.palmyrasys.www.webservices.CableAssurance.Topology.TopologyEP.class.isAssignableFrom(serviceEndpointInterface)) {
                com.palmyrasys.www.webservices.CableAssurance.Topology.TopologySOAPBindingStub _stub = new com.palmyrasys.www.webservices.CableAssurance.Topology.TopologySOAPBindingStub(new java.net.URL(TopologyEP_address), this);
                _stub.setPortName(getTopologyEPWSDDServiceName());
                return _stub;
            }
        }
