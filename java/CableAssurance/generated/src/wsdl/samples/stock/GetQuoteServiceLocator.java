...
public class GetQuoteServiceLocator extends org.apache.axis.client.Service implements wsdl.samples.stock.GetQuoteService {
    ...
    private java.lang.String GetQuote_address = "http://localhost:8080/CableAssurance/caservices/GetQuote";
    ...
    public wsdl.samples.stock.GetQuote getGetQuote(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsdl.samples.stock.GetQuoteBindingStub _stub = new wsdl.samples.stock.GetQuoteBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsdl.samples.stock.GetQuote.class.isAssignableFrom(serviceEndpointInterface)) {
                wsdl.samples.stock.GetQuoteBindingStub _stub = new wsdl.samples.stock.GetQuoteBindingStub(new java.net.URL(GetQuote_address), this);
                _stub.setPortName(getGetQuoteWSDDServiceName());
                return _stub;
            }
        }
