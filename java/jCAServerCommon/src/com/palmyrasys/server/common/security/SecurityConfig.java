 ...
 */
package com.palmyrasys.server.common.security;

import java.security.Security;
import com.palmyrasys.server.common.startup.ServerProperties;
...
public final class SecurityConfig{
    ...
    private SecurityConfig(){  
        try{
            packageDefinition = ServerProperties.getProperty("package.definition");
            packageAccess = ServerProperties.getProperty("package.access");
