...
#ifndef _axDbCAAlarmDevicePostSoak_hpp_
#define _axDbCAAlarmDevicePostSoak_hpp_
 ...
 * 
 * 
 * file/class: axDbCAAlarmDevicePostSoak.hpp
 * 
 * Design Document:
 * 
 * System:
...
class axDbCAAlarmDevicePostSoak : public axDbCAAlarm
{
public:
   ...
   */
  axDbCAAlarmDevicePostSoak(AX_UINT64, DB_RESID_t);

  /**
   * IN: Alarm ID
   */
  axDbCAAlarmDevicePostSoak(AX_UINT64);

  /**
   * Copy Constructor : apparently needed. Why?
   */
  axDbCAAlarmDevicePostSoak(const axDbCAAlarmDevicePostSoak &);

  /// default constructor
  axDbCAAlarmDevicePostSoak();

  /// destructor
  virtual ~axDbCAAlarmDevicePostSoak();
...
#endif // _axDbCAAlarmDevicePostSoak_hpp_
