...
#ifndef _axDbMtaProvStatusLog_hpp_
#define _axDbMtaProvStatusLog_hpp_
 ...
 * 
 * 
 * file/class: axDbMtaProvStatusLog.hpp
 * 
 * Design Document:
 * 
 * System:
...
class axDbMtaProvStatusLog : public axDbAbstractStatus
{
public:
   ...
   * IN: (e)MTA Res ID
   */
  axDbMtaProvStatusLog(DB_RESID_t);
   ...
   * IN: Internal (e)MTA;
   */
  axDbMtaProvStatusLog(DB_RESID_t, time_t, axIntGenMtaNonkey_t *);

  /// destructor
  virtual ~axDbMtaProvStatusLog();
...
protected:
  ...
  /// default constructor
  axDbMtaProvStatusLog();

private:

  // Copy disallowed
  axDbMtaProvStatusLog(const axDbMtaProvStatusLog &);

};

#endif // _axDbMtaProvStatusLog_hpp_
