/* AdminServAdministrationSOAPBindingProxy.h
...
#ifndef AdminServAdministrationSOAPBinding_H
#define AdminServAdministrationSOAPBinding_H
#include "AdminServH.h"
extern SOAP_NMAC struct Namespace AdminServ_namespaces[];
class AdministrationSOAPBinding
{   public:
	struct soap *soap;
	const char *endpoint;
	AdministrationSOAPBinding() { soap = soap_new(); if (soap) soap->namespaces = AdminServ_namespaces; endpoint = "http://localhost:8080/CableAssurance/caservices/AdministrationEP"; };
