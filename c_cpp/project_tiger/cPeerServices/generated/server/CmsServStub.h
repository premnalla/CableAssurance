...
#ifndef CmsServStub_H
#define CmsServStub_H
#include <vector>
...
SOAP_FMAC5 int SOAP_FMAC6 CmsServ_serve(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 CmsServ_serve_request(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve_cms__getLineStatus(struct soap*);

#endif

/* End of CmsServStub.h */
