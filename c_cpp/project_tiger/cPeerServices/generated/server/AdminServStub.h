...
#ifndef AdminServStub_H
#define AdminServStub_H
#include <vector>
...
SOAP_FMAC5 int SOAP_FMAC6 AdminServ_serve(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 AdminServ_serve_request(struct soap*);
