...
#ifndef cPeerServStub_H
#define cPeerServStub_H
#include <vector>
...
SOAP_FMAC5 int SOAP_FMAC6 cPeerServ_serve(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 cPeerServ_serve_request(struct soap*);
