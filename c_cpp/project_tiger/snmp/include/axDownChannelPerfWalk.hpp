...
#ifndef _axDownChannelPerfWalk_hpp_
#define _axDownChannelPerfWalk_hpp_
 ...
 * 
 * 
 * file/class: axDownChannelPerfWalk.hpp
 * 
 * Design Document:
 * 
 * System:
...
class axDownChannelPerfWalk : public axAbstractSnmpMultipleGetWork
{
public:

  /// data constructor
  axDownChannelPerfWalk(axInternalCmts *);

  /// destructor
  virtual ~axDownChannelPerfWalk();
...
private:
  ...
  axDownChannelPerfWalk(const axDownChannelPerfWalk &);

  void getValue(AX_INT32, AX_INT32, netsnmp_variable_list *);

  axSnmpDownChannelPerfOid_s           m_nextOids;
  axSnmpDownChannelPerfResultValues_s  m_decodedResponse;
  axSnmpDownChannelPerfReqType       * m_reqType;
  axInternalCmts                     * m_intCmts;
};

#endif // _axDownChannelPerfWalk_hpp_
