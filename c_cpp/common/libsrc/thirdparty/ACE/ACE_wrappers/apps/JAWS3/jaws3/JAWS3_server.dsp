...
!MESSAGE
!MESSAGE NMAKE CFG="JAWS3_server - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "JAWS3_server - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\JAWS3_server/" /I "..\..\.." /I ".." /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib JAWS3d.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:".\main.pdb" /debug /machine:I386 /out:".\main.exe"

!ELSEIF  "$(CFG)" == "JAWS3_server - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib JAWS3.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\main.exe"
