...
!MESSAGE
!MESSAGE NMAKE CFG="JAWS3 - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\JAWS3/" /I "..\..\.." /I ".." /D _DEBUG /D WIN32 /D _WINDOWS /D JAWS_BUILD_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:"..\..\..\lib\JAWS3d.pdb" /implib:"..\..\..\lib\JAWS3d.lib" /dll /debug /machine:I386 /out:"..\..\..\lib\JAWS3d.dll"

!ELSEIF  "$(CFG)" == "JAWS3 - Win32 Release"
...
# ADD BSC32 /nologo /o"..\..\..\lib\JAWS3.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\..\..\lib\JAWS3.lib" /dll  /machine:I386 /out:"..\..\..\lib\JAWS3.dll"
