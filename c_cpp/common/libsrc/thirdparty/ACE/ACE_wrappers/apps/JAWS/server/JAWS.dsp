...
!MESSAGE
!MESSAGE NMAKE CFG="JAWS - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\JAWS/" /I "..\..\.." /D _DEBUG /D WIN32 /D _WINDOWS /D ACE_BUILD_SVC_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:"..\..\..\lib\JAWSd.pdb" /implib:"..\..\..\lib\JAWSd.lib" /dll /debug /machine:I386 /out:"..\..\..\lib\JAWSd.dll"

!ELSEIF  "$(CFG)" == "JAWS - Win32 Release"
...
# ADD BSC32 /nologo /o"..\..\..\lib\JAWS.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\..\..\lib\JAWS.lib" /dll  /machine:I386 /out:"..\..\..\lib\JAWS.dll"
