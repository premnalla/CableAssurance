...
!MESSAGE
!MESSAGE NMAKE CFG="Gateway - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Gateway/" /I "..\..\.." /D _DEBUG /D WIN32 /D _WINDOWS /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:"..\..\..\lib\Gatewayd.pdb" /implib:"..\..\..\lib\Gatewayd.lib" /dll /debug /machine:I386 /out:"..\..\..\lib\Gatewayd.dll"

!ELSEIF  "$(CFG)" == "Gateway - Win32 Release"
...
# ADD BSC32 /nologo /o"..\..\..\lib\Gateway.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\..\..\lib\Gateway.lib" /dll  /machine:I386 /out:"..\..\..\lib\Gateway.dll"
