...
!MESSAGE
!MESSAGE NMAKE CFG="gatewayd - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\gatewayd/" /I "..\..\.." /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib Gatewayd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:".\gatewayd.pdb" /debug /machine:I386 /out:".\gatewayd.exe"

!ELSEIF  "$(CFG)" == "gatewayd - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib Gateway.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\gatewayd.exe"
