...
!MESSAGE
!MESSAGE NMAKE CFG="ACEXML - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\ACEXML/" /I "..\.." /D _DEBUG /D WIN32 /D _WINDOWS /D ACEXML_BUILD_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:windows /pdb:"..\..\lib\ACEXMLd.pdb" /implib:"..\..\lib\ACEXMLd.lib" /dll /debug /machine:I386 /out:"..\..\lib\ACEXMLd.dll"

!ELSEIF  "$(CFG)" == "ACEXML - Win32 Release"
...
# ADD BSC32 /nologo /o"..\..\lib\ACEXML.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\..\lib\ACEXML.lib" /dll  /machine:I386 /out:"..\..\lib\ACEXML.dll"
