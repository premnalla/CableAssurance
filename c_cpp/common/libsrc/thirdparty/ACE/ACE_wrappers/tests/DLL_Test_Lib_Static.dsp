...
!MESSAGE
!MESSAGE NMAKE CFG="DLL_Test_Lib_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "DLL_Test_Lib_Static - Win32 Debug"
...
# PROP Target_Dir ""
LINK32=link.exe -lib
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"..\lib\DLL_Test_Libsd.pdb" /I ".." /D _DEBUG /D WIN32 /D _WINDOWS /D ACE_AS_STATIC_LIBS /FD /c
# SUBTRACT CPP /Fr /YX
...
LIB32=link.exe -lib
# ADD LIB32 /nologo /out:"..\lib\DLL_Test_Libsd.lib"

!ELSEIF  "$(CFG)" == "DLL_Test_Lib_Static - Win32 Release"
...
# ADD BSC32 /nologo /o"..\lib\DLL_Test_Lib.bsc"
LIB32=link.exe -lib
# ADD LIB32 /nologo /out:"..\lib\DLL_Test_Libs.lib"
