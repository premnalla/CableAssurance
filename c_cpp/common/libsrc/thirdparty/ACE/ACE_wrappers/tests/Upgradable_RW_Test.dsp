...
!MESSAGE
!MESSAGE NMAKE CFG="Upgradable_RW_Test - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Upgradable_RW_Test/" /I ".." /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib Test_Outputd.lib /libpath:"." /libpath:"..\lib" /nologo /subsystem:console /pdb:".\Upgradable_RW_Test.pdb" /debug /machine:I386 /out:".\Upgradable_RW_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib Test_Output.lib /libpath:"." /libpath:"..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\Upgradable_RW_Test.exe"
