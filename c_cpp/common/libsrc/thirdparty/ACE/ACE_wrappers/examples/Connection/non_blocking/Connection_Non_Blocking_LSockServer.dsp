...
!MESSAGE
!MESSAGE NMAKE CFG="Connection_Non_Blocking_LSockServer - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "Connection_Non_Blocking_LSockServer - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Connection_Non_Blocking_LSockServer/" /I "..\..\.." /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:".\lsock_server.pdb" /debug /machine:I386 /out:".\lsock_server.exe"

!ELSEIF  "$(CFG)" == "Connection_Non_Blocking_LSockServer - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\lsock_server.exe"
