...
!MESSAGE
!MESSAGE NMAKE CFG="Nodelocal_Shared_Reader - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "Nodelocal_Shared_Reader - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Nodelocal_Shared_Reader/" /I "..\..\.." /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:".\Nodelocal_shared_reader.pdb" /debug /machine:I386 /out:".\Nodelocal_shared_reader.exe"

!ELSEIF  "$(CFG)" == "Nodelocal_Shared_Reader - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\Nodelocal_shared_reader.exe"
