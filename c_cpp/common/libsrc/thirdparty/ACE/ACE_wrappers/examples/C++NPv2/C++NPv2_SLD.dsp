...
!MESSAGE
!MESSAGE NMAKE CFG="C++NPv2_SLD - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\C++NPv2_SLD/" /I "..\.." /D _DEBUG /D WIN32 /D _WINDOWS /D SLD_BUILD_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:windows /pdb:"..\..\lib\SLDd.pdb" /implib:"..\..\lib\SLDd.lib" /dll /debug /machine:I386 /out:"..\..\lib\SLDd.dll"

!ELSEIF  "$(CFG)" == "C++NPv2_SLD - Win32 Release"
...
# ADD BSC32 /nologo /o"..\..\lib\SLD.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\..\lib\SLD.lib" /dll  /machine:I386 /out:"..\..\lib\SLD.dll"
