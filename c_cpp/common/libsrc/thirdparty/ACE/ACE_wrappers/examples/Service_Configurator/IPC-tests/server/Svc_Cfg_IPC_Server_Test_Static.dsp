...
!MESSAGE
!MESSAGE NMAKE CFG="Svc_Cfg_IPC_Server_Test_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "Svc_Cfg_IPC_Server_Test_Static - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Static_Debug\Svc_Cfg_IPC_Server_Test_Static/" /I "..\..\..\.." /D _DEBUG /D WIN32 /D _CONSOLE /D ACE_AS_STATIC_LIBS /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib IPC_Tests_Serversd.lib /libpath:"." /libpath:"..\..\..\..\lib" /nologo /subsystem:console /pdb:"Static_Debug\server_test.pdb" /debug /machine:I386 /out:"Static_Debug\server_test.exe"

!ELSEIF  "$(CFG)" == "Svc_Cfg_IPC_Server_Test_Static - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib IPC_Tests_Servers.lib /libpath:"." /libpath:"..\..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Static_Release\server_test.exe"
