...
!MESSAGE
!MESSAGE NMAKE CFG="ASX_Message_Queue_Buffer_Stream_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "ASX_Message_Queue_Buffer_Stream_Static - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Static_Debug\ASX_Message_Queue_Buffer_Stream_Static/" /I "..\..\.." /D _DEBUG /D WIN32 /D _CONSOLE /D ACE_AS_STATIC_LIBS /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:"Static_Debug\buffer_stream.pdb" /debug /machine:I386 /out:"Static_Debug\buffer_stream.exe"

!ELSEIF  "$(CFG)" == "ASX_Message_Queue_Buffer_Stream_Static - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib /libpath:"." /libpath:"..\..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Static_Release\buffer_stream.exe"
