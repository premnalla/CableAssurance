...
!MESSAGE
!MESSAGE NMAKE CFG="Bounded_Packet_Relay - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "Bounded_Packet_Relay - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Bounded_Packet_Relay/" /I "..\.." /D _DEBUG /D WIN32 /D _CONSOLE /D ACE_HAS_DEFERRED_TIMER_COMMANDS /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:console /pdb:".\bpr_thread.pdb" /debug /machine:I386 /out:".\bpr_thread.exe"

!ELSEIF  "$(CFG)" == "Bounded_Packet_Relay - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\bpr_thread.exe"
