...
!MESSAGE
!MESSAGE NMAKE CFG="Kokyu - Win32 Debug"
!MESSAGE
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\Kokyu/" /I ".." /D _DEBUG /D WIN32 /D _WINDOWS /D KOKYU_BUILD_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"." /libpath:"..\lib" /nologo /subsystem:windows /pdb:"..\lib\Kokyud.pdb" /implib:"..\lib\Kokyud.lib" /dll /debug /machine:I386 /out:"..\lib\Kokyud.dll"

!ELSEIF  "$(CFG)" == "Kokyu - Win32 Release"
...
# ADD BSC32 /nologo /o"..\lib\Kokyu.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"." /libpath:"..\lib" /nologo /subsystem:windows /pdb:none /implib:"..\lib\Kokyu.lib" /dll  /machine:I386 /out:"..\lib\Kokyu.dll"
