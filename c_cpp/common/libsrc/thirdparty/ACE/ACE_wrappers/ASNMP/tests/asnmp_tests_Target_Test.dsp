...
!MESSAGE
!MESSAGE NMAKE CFG="asnmp_tests_Target_Test - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "asnmp_tests_Target_Test - Win32 Debug"
...
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /Fd"Debug\asnmp_tests_Target_Test/" /I "..\.." /I "..\..\ASNMP" /D _DEBUG /D WIN32 /D _CONSOLE /FD /c
# SUBTRACT CPP /YX
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib asnmpd.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:console /pdb:".\Target_Test.pdb" /debug /machine:I386 /out:".\Target_Test.exe"

!ELSEIF  "$(CFG)" == "asnmp_tests_Target_Test - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib asnmp.lib /libpath:"." /libpath:"..\..\lib" /nologo /subsystem:console /pdb:none  /machine:I386 /out:"Release\Target_Test.exe"
