...
int main (void)
{
	...
	if (strcmp(MO1->oid(), "SPACE/HOSTNAME/1") == 0)
	{
		cout << "SUCCESS " << endl;
	}
	else
	...
	if (strcmp(MO2->oid(), "SPACE/HOSTNAME/2") == 0)
	{
		cout << "SUCCESS " << endl;
	}
	else
	...
	if (MO1 = (txMemObj*) MM->accessObject("SPACE/HOSTNAME/1"))
	{
		if (strcmp(MO2->oid(), "SPACE/HOSTNAME/2") == 0)
		{
	...
	if (MO3 = (txMemObj*) MM->accessObject("SPACE/HOSTNAME/3"))
	{
		if (strcmp(MO3->oid(), "SPACE/HOSTNAME/3") == 0)
		{
	...
	delete MO2; MO2 = 0;
	if (!(MO2 = (txMemObj*) MM->accessObject("SPACE/HOSTNAME/2")))
	{
