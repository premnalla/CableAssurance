...
// -------- PLEASE READ, BEGIN ---------
//
// THIS EXAMPLE IS IDENTICAL TO THE NATIVE THREADING EXAMPLE txtest_nthrdmgr.cxx
...
int main (void)
{
	...
	txThread::start(timerTest, 0, "timerTest", 255);

	// creating the txThread on the stack
	//     priority:    100
	//     name:       "THRD_MGR"
	//     min_threads: 5
	//     max_threads: 10
	txThreadManager threadMgr(100, "THRD_MGR", 5, 10, 5, 10);
	...
	// having the txThreadManager start the threads
	...
	while (!G_EXIT_FLAG)
	{
		...
		// having the txThreadManager start more threads
