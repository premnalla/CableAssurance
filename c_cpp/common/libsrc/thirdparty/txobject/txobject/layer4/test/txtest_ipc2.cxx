...
static int G_THREAD_PRIORITY = 4;
...
void ipcTest (void* obj)
{
	...
	G_IPCSERVER = new txIPCServer(self, G_THREAD_PRIORITY);
	...
	G_IPCSERVER->sendTo(msg, str_length, peer1);
	...
	while (!G_EXIT_FLAG)
	{
		...
		for (int i = 0; i < entries; i++)
		{
			...
			G_IPCSERVER->sendTo(msg, str_length, *peer);
	...
	delete msg; msg = 0;
	delete G_IPCSERVER; G_IPCSERVER = 0;
}
...
int main(int argc, char** argv)
{
	...
	txThread::start(ipcTest, argv, "ipcTest", G_THREAD_PRIORITY);
...
void receiveData (void*)
{
	...
	while (!G_EXIT_FLAG)
	{
		if (G_IPCSERVER && G_LIST_OF_PEERS.entries())
		{
