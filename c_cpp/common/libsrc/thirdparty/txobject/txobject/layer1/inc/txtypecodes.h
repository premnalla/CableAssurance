...
const unsigned long TX_OCTET_STRING	= 0x70000000;	// v1.0
const unsigned long TX_OCTET_STRINGR0	= 0x70000000;	// v1.0
const unsigned long TX_OCTET_STRINGR1	= 0x70000001;	// v1.0
const unsigned long TX_OCTET_STRINGR2	= 0x70000002;	// v1.0
const unsigned long TX_OCTET_STRINGR3	= 0x70000003;	// v1.0

const unsigned long TX_LIST		= 0x80000000;	// v1.0
const unsigned long TX_TABLE		= 0x80000001;	// v1.0
