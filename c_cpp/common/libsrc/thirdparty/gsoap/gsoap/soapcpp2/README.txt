...
choose which license applies best for your use.  The wsdl2h WSDL parser and
UDDI code are distributed under the GPL or a commercial license. The
commercial license covers all software components and eliminates the GPL terms
and conditions.  The commercial use license is available from Genivia Inc, see
