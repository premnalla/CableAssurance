...
#ifndef _axAbstractSessionHelper_hpp_
#define _axAbstractSessionHelper_hpp_
 ...
 * 
 * 
 * file/class: axAbstractSessionHelper.hpp
 * 
 * Design Document:
 * 
 * System:
...
class axAbstractSessionHelper 
{
public:

  /// destructor
  virtual ~axAbstractSessionHelper();
...
protected:
  ...
  /// default constructor
  axAbstractSessionHelper();

private:

  axAbstractSessionHelper(const axAbstractSessionHelper &);

};

#endif // _axAbstractSessionHelper_hpp_
